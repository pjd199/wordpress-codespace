...
sudo curl -L -o /usr/local/bin/wpc https://raw.githubusercontent.com/pjd199/wordpress-codespace/refs/tags/0.0.8/wpc.sh

# Make it executable
sudo chmod 777 /usr/local/bin/wpc
```
...
```json
{
  ...
  "postCreateCommand": "sudo curl -L -o /usr/local/bin/wpc https://raw.githubusercontent.com/pjd199/wordpress-codespace/refs/tags/0.0.8/wpc.sh && sudo chmod 777 /usr/local/bin/wpc",
